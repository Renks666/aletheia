  ...
  "focus-ring inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full border text-sm font-semibold transition-all disabled:pointer-events-none disabled:opacity-60",
  {
    variants: {
      variant: {
        ...
        secondary:
          "border-line-strong bg-[color:color-mix(in_srgb,var(--color-surface-900)_65%,transparent)] px-5 py-3 text-muted hover:-translate-y-0.5 hover:border-bronze-300 hover:bg-[color:color-mix(in_srgb,var(--color-surface-900)_82%,transparent)] hover:text-text",
        ghost:
