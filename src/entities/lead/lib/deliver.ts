    ...
    try {
      await transporter.sendMail({
        ...
        text: [
          ...
          `Source detail: ${payload.sourceDetail || "-"}`,
          `Landing variant: ${payload.landingVariant || "-"}`,
  ...
  if (TELEGRAM_WEBHOOK_URL) {
    try {
      const telegramMessage = [
        ...
        payload.sourceDetail ? `Source detail: ${payload.sourceDetail}` : "",
        payload.landingVariant ? `Landing variant: ${payload.landingVariant}` : "",
